...
public class GoogleEvaluator {
	...
	public GoogleEvaluator(int TOPK, boolean isBaseline) {
		this.goldFolder = StaticData.EXP_HOME
				+ "/search-engine-resx/google/goldset";
		this.resultFolder = StaticData.EXP_HOME + "/search-engine-resx/google/"
	...
	public static void main(String[] args) {
		...
		int TOPK = 10;
		boolean isBaseline = false;
		new GoogleEvaluator(TOPK, isBaseline).determinePerformance(TOPK);
