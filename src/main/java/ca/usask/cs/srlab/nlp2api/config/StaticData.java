...
public class StaticData {
    ...
    public static String CANDIDATE_FOLDER = EXP_HOME + "\\candidate";
    public static String EMBEDDING_FOLDER = EXP_HOME + "\\embeddings";
    ...
    public static boolean COMBINE_QA_CODES = true;
